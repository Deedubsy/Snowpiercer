...
namespace CityGeneration.Buildings
{
    ...
    // BuildingContext moved to CityGenerationTypes.cs
    ...
    // WealthLevel moved to CityGenerationTypes.cs

    // ClimateType and WindDirection moved to CityGenerationTypes.cs
}