...
namespace CityGeneration.Rules.SpecificRules
{
    ...
    public class DistanceRule : PlacementRule
    {
        ...
        private DistrictType GetDistrictTypeFromBuilding(CityGeneration.Generators.BuildingType buildingType)
        {
            switch (buildingType)
            {
                case CityGeneration.Generators.BuildingType.Castle:
                    return DistrictType.Castle;
                case CityGeneration.Generators.BuildingType.Cathedral:
                    return DistrictType.Religious;
                case CityGeneration.Generators.BuildingType.Shop:
                    return DistrictType.Market;
                case CityGeneration.Generators.BuildingType.Workshop:
                    return DistrictType.Artisan;
                case CityGeneration.Generators.BuildingType.Barracks:
                    return DistrictType.Military;
                case CityGeneration.Generators.BuildingType.House:
                    return DistrictType.Residential;
                case CityGeneration.Generators.BuildingType.Tavern:
                    return DistrictType.Market;
                default:
                    return DistrictType.Residential;
            }
