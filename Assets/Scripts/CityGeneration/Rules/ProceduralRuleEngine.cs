...
namespace CityGeneration.Rules
{
    ...
    public class ProceduralRuleEngine
    {
        ...
        /// </summary>
        public async Task<PlacementResult> FindBestBuildingPosition(BuildingType buildingType, Vector3 districtCenter, float districtRadius, PlacementContext context)
        {
            currentContext = context;
        ...
        private PlacementRule[] GetRulesForBuilding(BuildingType buildingType)
        {
            var rules = new List<PlacementRule>(globalRules);
        ...
        private DistrictType GetDistrictTypeFromBuilding(BuildingType buildingType)
        {
            switch (buildingType)
            {
                case BuildingType.Castle: return DistrictType.Castle;
                case BuildingType.Cathedral: return DistrictType.Religious;
                case BuildingType.Shop: return DistrictType.Market;
                case BuildingType.Workshop: return DistrictType.Artisan;
                case BuildingType.Barracks: return DistrictType.Military;
                case BuildingType.Tavern: return DistrictType.Market;
